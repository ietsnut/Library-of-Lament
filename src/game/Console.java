...
public class Console {
    ...
    // Retrieves the caller's simple class name by filtering out Thread and Console.
    ...
    // Automatically prepend the caller's simple name and the thread ID to the messages.
