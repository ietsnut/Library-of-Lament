...
public class Material2 implements Resource {
    ...
    public Material2(String name) {
        this.file = "/resources/" + name + ".png";
        this.queue();
    }

    public Material2(String type, String name) {
    ...
    @Override
    public void load() {
        try (InputStream in = Material2.class.getResourceAsStream(file)) {
            if (in == null) {
    ...
    private byte[] generateMipLevel(byte[] sourcePixels, int sourceWidth, int sourceHeight, int targetWidth,
            int targetHeight) {
    ...
    public boolean equals(Object obj) {
        return obj instanceof Material2 material && this.file.equals(material.file);
    }
