...
void main(void) {
    ...
    float back          = 1 - (blendMapColour.r + blendMapColour.g + blendMapColour.b);
    vec2 tiledCoords    = fragUV * 40;
    vec4 backColor      = tile(0, tiling) * back;
    ...
    vec4 albedo         = backColor + rTextureColour + gTextureColour + bTextureColour;
